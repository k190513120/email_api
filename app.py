...
# 导入同步模块
try:
    from douyin_sync_action import DouyinVideoSyncer
except ImportError as e:
    print(f"导入错误: {e}")
    DouyinVideoSyncer = None
...
def get_status():
    ...
    try:
        ...
        # 检查模块状态
        module_status = {
            'douyin_syncer_loaded': DouyinVideoSyncer is not None
        }
